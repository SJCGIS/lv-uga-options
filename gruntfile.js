...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        connect: {
            ...
            cdn: { options: { base: 'src' } },
            // load built app
            build: { options: { base: 'dist' } }
        },
        //Open default browser at the app
        open: {
            cdn: { path: 'http://localhost:<%= connect.options.port %>/' },
            build: { path: 'http://localhost:<%= connect.options.port %>/' }
        },
        //setup watch tasks
        watch: {
            options: {
        ...
        dojo: {
            ...
            options: {
                ...
                releaseDir: '../dist',
                // Optional: release dir rel to basePath (Default: 'release')
                cwd: './',
        ...
        processhtml: { build: { files: { 'dist/index.html': ['src/index.html'] } } },
        'gh-pages': {
            options: { base: 'src' },
            src: [
                'app/**',
